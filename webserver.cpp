...
void WebServer::sql_pool()
{
    ...
    m_connPool->init("172.17.0.1", m_user, m_passWord, m_databaseName, 33007, m_sql_num, m_close_log);
...
bool WebServer::dealwithsignal(bool &timeout, bool &stop_server)
{
    ...
    //非阻塞读 可能会读不到数据 返回false 会导致定时时间失效
