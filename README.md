...
```C++
./server -p 9007 -l 1 -m 0 -o 1 -s 8 -t 8 -c 1 -a 1
```
...
###进入mysql容器
docker exec -it 3f238c098f7d /bin/bash

###数据库登录
mysql -u root -p123456

docker run --name mysql -v /home/node11/mysql/var/lib/mysql -p 3306:3306 -e MYSQL_ROOT_PASSWORD=123456 -d mysql:latest
